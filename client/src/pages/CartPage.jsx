...
export const CartPage = () => {
  return (
    <Layout>
      <div className="flex h-screen w-auto p-3 md:flex-row gap-3 sm:flex-col">
        ...
        <div className="RIGHT  w-[30%] rounded-lg bg-[#EFEEEE]/70 p-4 flex flex-col gap-3">
          <span className="mb-0 font-semibold text-xl">Order Summary</span>
          <div className="PROMO_CODE w-full flex flex-col gap-3 ">
            ...
            <div className=" justify-between align-middle items-center ">
              ...
              />
              <button className="absolute right-7 h-10 px-7 rounded-badge bg-black rounded-x-full transform active:scale-95 active:shadow-lg transition duration-150 text-white">
                Apply
              </button>
            </div>
            ...
            <>
              <div className=" text-[#746E6E] font-medium flex flex-col gap-2">
                ...
                <div className="flex justify-between">
                  <span className="font-semibold ml-1 text-black">Offer :</span>
            ...
            <button className="CHECKOUT_BUTTON rounded-md bg-black text-white font-bold text-lg p-2 shadow-sm drop-shadow-md transform active:scale-95 active:shadow-lg transition duration-150">
              CHECKOUT
            </button>
          </div>
        </div>
