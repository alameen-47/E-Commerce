...
export const CartPage = () => {
  return (
    <Layout>
      <div className="bg-red-600 flex h-screen w-auto p-3 flex-row gap-3">
        <div className="LEFT bg-green-700 w-[70%] rounded-lg p-2">
          ...
          <div className="PRODUCT-CARD-CONTAINER bg-[#E3E2E2] !w-full  h-[20%] rounded-lg flex flex-row  justify-between ">
            <div className="CARD-CONTENT w-auto p-2 flex flex-row  gap-2">
              <Checkbox />
              <div className="IMAGE skeleton h-32 w-36"></div>
              <div className="DETAILS w-[50%] h-[70%]  flex flex-col justify-between gap-1.5">
                <span className="NAME font-bold text-xl">WOOD LAND SHOES</span>
                <span className="DESCRIPTION md:flex sm:hidden text-[#746E6E] font-semibold text-md">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim
                  aliquid voluptates nemo sequi,
                </span>
                <div className=" SUB-DETAILS  h-[30%]  flex flex-row items-center align-middle gap-5">
                  <span className="COLOR text-[#746E6E] font-medium">
                    Color:
                    <span className="font-semibold ml-1 text-black">Black</span>
                  </span>
                  <span className="SIZE text-[#746E6E]">
                    Size:
                    <span className="font-semibold ml-1 text-black">45</span>
                  </span>
                  <div className="QUANTITY bg-white h-full w-[22%] rounded-badge flex justify-center items-center align-middle gap-1">
                    <FaPlus />
                    <input
                      defaultValue={1}
                  ...
                  <div className="DELETE bg-white drop-shadow-lg shadow-md rounded-md p-1.5 items-center">
                    <RiDeleteBin6Line />
                  </div>
                  <div className="LIKE bg-white drop-shadow-lg shadow-md rounded-full p-1.5 items-center">
                    <FaHeart className="w-4 h-4" />
                  </div>
                </div>
              </div>
            </div>
            <div className="PRICE-SECTION  h-full p-2 flex flex-col justify-center align-middle items-center">
              <div className="OFFER flex gap-1 justify-center align-bottom  items-end">
                <strike className="text-[#746E6E] font-medium">SR:930/-</strike>
                <span className="font-bold text-xl text-[#D00000] ">55%</span>
              </div>
              <div className="font-bold text-2xl">SR:450/-</div>

              <img src={delivery} alt="" className="w-18 h-10 " />
            </div>
          </div>
        </div>
        <div className="RIGHT bg-blue-700 w-[30%] rounded-lg"></div>
      </div>
    </Layout>
  );
};
